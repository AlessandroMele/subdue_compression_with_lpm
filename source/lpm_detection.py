...
def lpm_detection(Min_prefix_size, Max_prefix_size, event_log_address, output_address_name_file, LPMs_folder_name):
    # import log once in xes format
    Original_log = xes_importer.apply(event_log_address)
    #Laura's change: adding the event number for sorting
